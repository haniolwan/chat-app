    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center">
            <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="relative flex items-center">
                                <input name="password"
                                    ...
                                    onChange={handleChange} />
                                {showPassword ? (
                                    <svg onClick={() => setShowPassword(false)} className="w-[18px] h-[18px] absolute right-2 cursor-pointer" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg onClick={() => setShowPassword(true)} xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2 cursor-pointer" viewBox="0 0 128 128">
                ...
                <div className="hidden md:block md:h-full bg-[#000842] rounded-xl lg:p-12 p-8">
