...
const MessageItem = ({ name, message, time, avatar, statusIcon, unreadCount }) => (
  <div className="grid grid-cols-12 gap-1 p-2 items-center border-b border-gray-700">
    ...
    <div className="col-span-1 text-right">
      <span className="text-gray-400 text-sm relative top-2">{time}</span>
    </div>
    <div className="col-span-2 flex justify-end items-center space-x-2">
      ...
      {unreadCount > 0 && (
        <div className="bg-blue-500 text-white text-xs rounded w-10 h-6 flex items-center justify-center relative top-2">
          {unreadCount}
        </div>
      )}
    </div>
